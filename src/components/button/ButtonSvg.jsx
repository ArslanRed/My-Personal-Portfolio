...
const ButtonSvg = ({white }) => (
  <>
    <svg className="svg-left" width="21" height="44" viewBox="0 0 21 44" aria-hidden="true" focusable="false">
      <path
    ...
    <svg className="svg-right" width="21" height="44" viewBox="0 0 21 44" aria-hidden="true" focusable="false">
      <path
        fill={white ? "white" : "none"}
